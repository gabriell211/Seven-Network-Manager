...
pub fn foundation_capabilities() -> Vec<CapabilityDescriptor> {
    vec![
        ...
        CapabilityDescriptor {
            kind: CapabilityKind::DiscoveryRead,
            mode: CapabilityMode::Read,
            placement: ExecutionPlacement::LocalRuntime,
            supported_transports: vec![TransportKind::Icmp, TransportKind::Arp, TransportKind::Dns, TransportKind::Tcp],
            requires_approval: false,
            requires_snapshot: false,
        },
        CapabilityDescriptor {
        ...
        CapabilityDescriptor {
            kind: CapabilityKind::TelemetryRead,
            mode: CapabilityMode::Read,
            placement: ExecutionPlacement::LocalRuntime,
            supported_transports: vec![TransportKind::Snmp],
            requires_approval: false,
